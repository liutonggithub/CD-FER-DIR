...
fer_dataset = ["JAFFE", "Oulu_CASIA", "RAF-DB", "SFEW"]
available_datasets = pacs_dataset + officehome_dataset + digits_datset + fer_dataset
...
def get_train_dataloader(source_list=None, batch_size=64, image_size=224, crop=False, jitter=0, args=None, config=None):
    ...
    loader = DataLoader(dataset, batch_size=batch_size, shuffle=True, num_workers=0, pin_memory=False, drop_last=True)
    return loader
